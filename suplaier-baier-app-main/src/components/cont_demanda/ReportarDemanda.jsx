...
export const ReportarDemanda = ({setShowVentanaReportar, setShowReporteEnviado, demanda, producto}) => {
        ...
        <form onSubmit={onClickReportarConfirmar}>
          <div className="reportaOferta__box">
            <div className="explorarCat__title">
              <p className="paragraph--mid"><b>Reportar demanda: {producto?.Name}</b></p>
            </div>
