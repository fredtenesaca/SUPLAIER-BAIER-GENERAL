...
export const ResumenProducto = ({
  ...
  useEffect(() => {
    if (productData.urlImg !== "no-img.jpeg") getImg(productData.urlImg);
    else setImagen("no-img.jpeg");
  }, [productData]);
      ...
      <div className="resumenProducto__ventana animate__animated animate__slideInDown">
        ...
        <div className="resumenProducto__ventana__contenido">
          ...
          <div className="compraProducto__box">
            <div className="oferta-detalle__productoBox u-margin-top-small">
              {imagen !== "" ? (
                <img
                  src={imagen}
                  alt={"producto"}
                  className="resumenProducto__ventana__img"
                />
              ) : (
            ...
            <div className="oferta-detalle__productoBox u-margin-top-small">
              <p className="paragraph">
                <b>Nombre:</b> {productData.nombreProducto}
              </p>
            </div>

            <div className="oferta-detalle__productoBox u-margin-top-small">
              <p className="paragraph">
                <b>Categoría:</b> {JSON.parse(productData.categoria).Nombre}
              </p>
            </div>
            <div className="oferta-detalle__productoBox u-margin-top-small">
              <p className="paragraph">
                <b>Comprador:</b> {productData.nombreProveedor}
              </p>
            </div>
            {/* <div className="oferta-detalle__productoBox u-margin-top-small">
